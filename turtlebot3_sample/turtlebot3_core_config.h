...
// IR Sensor current value
std_msgs::Int32 irm_msg;
ros::Publisher irm_pub("irmid_reading", &irm_msg);
std_msgs::Int32 irl_msg;
ros::Publisher irl_pub("irleft_reading", &irl_msg);
std_msgs::Int32 irr_msg;
ros::Publisher irr_pub("irright_reading", &irr_msg);
...
/*******************************************************************************
* Declaration for IR Sensors
*******************************************************************************/
#define shrtmodel 1080
#define longmodel 20150
#define mfwdIrPin A4 //Middle forward IR
#define lfwdIrPin A0 //Left forward IR
